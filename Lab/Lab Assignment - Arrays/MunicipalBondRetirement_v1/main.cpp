...
int main(int argc, char** argv) {
    ...
    cout << "With a Yearly Salary of $" << salary
            <<" and an investment rate of " << intRate * CNVDCML
            << "%," << "\n";
    cout << "you will need a savings of $" << sav2Rtr
            << " at Retirement." << "\n";
    cout << "Is " << yrDpPc * CNVDCML << "% = $" << yrDep 
            << "/year enough for " << nYears
            << " years to reach the goal?" << "\n";
    cout << "Year  Year       Balance      Interest       Deposit" << "\n";
    cout << setw(4) << year << setw(6) << dYear
            << setw(14) << balance << setw(14)
            << interest << setw(14) << yrDep << "\n";
    ...
    if(balance > sav2Rtr){
        cout << "Yes you reached your retirement goal" << "\n";
    }else{
        cout << "You failed to reach your retirement goal" << "\n";
    }
    //Exit stage right!
    return 0;
}